...
- Adds proper newlines around version and section headers ([#318](https://github.com/dangoslen/dependabot-changelog-helper/pull/324)). This will only add newlines if **adding** a new version and section. When adding a new entry, the newlines will not be added.
